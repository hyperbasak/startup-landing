...
function SectionHeader() {
  return (
    <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-16">
      <SectionBadge text="Strategic Difference" variant="primary" />
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4 mt-6 text-balance">
        기존 마케팅 대행 vs <span className="text-primary">Growth OS</span>
      </h2>
    ...
    <div className="mt-8 max-w-5xl mx-auto">
      <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 text-center">
        <p className="text-foreground font-medium text-lg [word-break:keep-all]">
          Growth OS는 단순 광고 집행을 넘어,{" "}
          <span className="text-primary">
            기존 대행의 한계를 기술로 해결한 프리미엄 매니지먼트 서비스
          </span>
          입니다.
        </p>
      </div>

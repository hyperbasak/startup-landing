    ...
    comparisons: [
      {
        ...
        blockMarketing: "귀사 비즈니스 모델에 최적화된 맞춤 전략"
      },
      {
        category: "데이터 분석",
        legacy: "광고 매체의 성과 수치에 집중",
        blockMarketing: "실질적 영업이익과 고객 가치 중심의 분석"
      },
      {
        category: "비용 성격",
        legacy: "성과 확인 후 사라지는 소모성 광고비",
        blockMarketing: "비즈니스 가치를 높이는 자본적 투자"
      },
      {
        category: "최종 결과",
        legacy: "일회성 매출 상승과 운영 리포트",
        blockMarketing: "지속 가능한 성장을 위한 데이터 자산화"
      },
    ],
  },
  {
    ...
    comparisons: [
      {
        ...
        blockMarketing: "해당 산업군 성공 데이터를 통한 전문 인사이트",
      },
      {
        category: "성장 속도",
        legacy: "시행착오를 거치며 느리게 학습",
        blockMarketing: "이미 검증된 가설을 바탕으로 즉각적인 성과",
      },
      {
        category: "운영 기반",
        legacy: "담당자 개인의 역량과 주관에 의존",
        blockMarketing: "객관적 지표에 근거한 정밀한 최적화 시스템",
      },
      {
        category: "지속 가능성",
        legacy: "퇴사 시 데이터 및 히스토리 단절 리스크",
        blockMarketing: "인적 의존 없는 영구적인 운영 프로세스 구축",
      },
    ],
  },
];

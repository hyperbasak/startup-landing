  ...
  return (
    <div className="group relative bg-card rounded-xl border border-border p-4 lg:p-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 hover:border-primary/20">
      <div className="flex items-start gap-3 mb-3">
        <div className="w-10 h-10 rounded-xl bg-destructive/10 flex items-center justify-center shrink-0 transition-transform duration-300 group-hover:scale-105 mt-0.5">
          <Icon className="w-5 h-5 text-destructive" strokeWidth={1.5} />
        </div>
        <div className="flex-1 min-w-0">
          <h3 className="text-base lg:text-lg font-semibold text-foreground leading-snug flex-1 [word-break:keep-all]">
            {barrier.question}
          </h3>
      ...
      <p className="text-sm text-muted-foreground leading-relaxed [word-break:keep-all]">
        <span className="font-medium text-foreground">{barrier.title}</span>
